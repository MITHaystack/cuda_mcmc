...
visgen -n $(basename $1 .fits) -s ALMA50 -A $SIM/array/sgra_array.txt -G  $(basename $1 .fits)_Visibility.dat  -V sgra_obs_spec -v -N -p $(basename $1 .fits)_uvdata.txt
...
cp $(basename $1 .fits)_uvdata.txt $(basename $1 .fits)_Visibility.dat $(basename $1 .fits).fits ../lib2xrgaus
